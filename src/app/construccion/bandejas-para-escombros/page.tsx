  ...
  return (
    <>
      ...
      <section className="relative w-full overflow-hidden" style={{ aspectRatio: "21/9", minHeight: "420px" }}>
        ...
        <div className="absolute right-0" style={{ maxWidth: "525px", bottom: "16px", zIndex: 2 }}>
          <div className="px-10 py-8 flex flex-col gap-2" style={{ background: "rgba(13,21,40,0.65)" }}>
            ...
            <p className="text-white/75 leading-relaxed mb-4" style={{ fontSize: "15px", width: 0, minWidth: "100%" }}>
              Solución para el retiro de material de escombros en pisos sin necesidad de utilizar la grúa, optimizando los tiempos de faena.
            </p>
            <div className="grid grid-cols-3 gap-px" style={{ background: "rgba(255,255,255,0.1)" }}>
              {[
                { top: "Material", bottom: "Acero Estructural" },
                { top: "Aplicación", bottom: "Construcción en Altura" },
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { sector: "Construcción en Altura", detalle: "Edificios y obras en altura que requieren retiro de escombros por piso" },
                { sector: "Demolición", detalle: "Trabajos de demolición controlada y retiro de material" },
              ].map((s) => (
      ...
      <Footer />
      <ProductosCarruselConstruccion excludeId="bandejas-para-escombros" />
      <WhatsAppButton />
    </>
  );
}
