        ...
        <section style={{ background: "#06101e" }} className="py-20 overflow-hidden">
          <div className="max-w-[1100px] mx-auto px-6 md:px-16">
            ...
            <div className="mt-16 pt-10" style={{ borderTop: "1px solid rgba(224,120,32,0.3)" }}>
              <p className="lg:whitespace-nowrap" style={{ fontSize: "clamp(1.05rem, 1.8vw, 1.4rem)", color: "rgba(255,255,255,0.7)", fontWeight: 300 }}>
                <span style={{ color: "#e07820", fontSize: "2.4em", lineHeight: 0, verticalAlign: "middle", fontFamily: "Georgia, serif", fontWeight: 700 }}>{"“"}</span>Con nuestros <strong style={{ color: "#ffffff", fontWeight: 600 }}>Capachos Roll Over</strong> cargas desde cualquier lugar de la obra — incluso <strong style={{ color: "#ffffff", fontWeight: 600 }}>a pie de calle</strong>.<span style={{ color: "#e07820", fontSize: "2.4em", lineHeight: 0, verticalAlign: "middle", fontFamily: "Georgia, serif", fontWeight: 700 }}>{"”"}</span>
              </p>
            </div>
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className={`absolute left-1/2 -translate-x-1/2 w-44 px-3 py-2 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none ${h.tooltipDown ? "top-full mt-2" : "bottom-full mb-2"}`}
                        ...
                        <p className="text-white text-xs font-bold">{h.num} {h.titulo}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="lg:order-1">
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <div className="flex items-start gap-4 px-5 py-4 rounded-lg" style={{ background: "rgba(180,20,20,0.28)", border: "1px solid rgba(204,0,0,0.6)" }}>
                    ...
                    <p style={{ fontSize: "clamp(0.98rem, 1.3vw, 1.1rem)", color: "rgba(255,200,200,0.95)", lineHeight: 1.6, textAlign: "justify" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-start">
              ...
              <div className="flex flex-col items-center gap-4 mx-auto w-full" style={{ maxWidth: "480px" }}>
                ...
                <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "clamp(0.8rem, 1vw, 0.9rem)", textAlign: "center", lineHeight: 1.5 }}>
                  3 puntos de agarre con grip en cada varilla, largo ajustable con perilla twist pull, conexion rapida a cuerpo central, cilindro central sin estrangulación de caudal de la manga
                </p>
              </div>
