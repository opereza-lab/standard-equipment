  ...
  return (
    <>
      ...
      <main>
        ...
        {/* 2. SPLIT — contenido izquierda · imagen derecha */}
        <section className="relative w-full overflow-hidden" style={{ background: "#06101e" }}>
          <div className="flex flex-col lg:flex-row" style={{ minHeight: "420px" }}>

            {/* ── Contenido izquierda ── */}
            <div
              className="flex-1 flex flex-col justify-center px-10 py-16 lg:px-20 lg:py-20"
              style={{ maxWidth: "50%", zIndex: 2 }}
            >
              <p
                className="text-[#e07820] font-semibold uppercase mb-4"
                style={{ fontSize: "clamp(0.7rem, 1vw, 0.85rem)", letterSpacing: "0.2em" }}
              >
                Concepto · Innovación
              </p>
              <h2
                className="mb-5"
                style={{ fontSize: "clamp(1.6rem, 3.2vw, 2.8rem)", fontWeight: 300, color: "#ffffff", lineHeight: 1.15 }}
              >
                Diseñado para cargar<br />
                <strong style={{ fontWeight: 700 }}>desde la calle</strong>
                <span style={{ color: "#e07820", fontWeight: 700 }}>.</span>
              </h2>
              <p
                className="text-white/70"
                style={{ fontSize: "clamp(0.9rem, 1.4vw, 1.05rem)", lineHeight: 1.7, maxWidth: "480px" }}
              >
                El Capacho Roll Over elimina la necesidad de excavaciones y accesos especiales para el mixer.
                Carga desde cualquier punto de la obra, a nivel de calle, con total seguridad.
              </p>
              <div className="mt-8 flex items-center gap-3">
                <div style={{ width: "36px", height: "2px", background: "#e07820" }} />
                <span className="text-white/50 text-sm uppercase tracking-widest">Standard Equipment · Chile</span>
              </div>
            </div>

            {/* ── Imagen derecha ── */}
            <div className="flex-1 relative group/img" style={{ minHeight: "420px" }}>
              <Image
                src="/images/productos/capacho-roll-ver/roll-over-hero2.png"
                alt="Capacho Concretero Roll Over en obra"
                fill
              ...
              />
              {/* Degradado lateral izquierdo — fusiona con el contenido */}
              <div
                className="absolute inset-0 pointer-events-none"
                style={{ background: "linear-gradient(to right, #06101e 0%, transparent 30%)" }}
              />
              {/* Degradado inferior */}
              <div
                className="absolute inset-0 pointer-events-none"
                style={{ background: "linear-gradient(to bottom, rgba(0,0,0,0.18) 0%, transparent 30%, transparent 60%, rgba(0,0,0,0.65) 100%)" }}
              />
              {/* Borde naranja top-right */}
              <div className="absolute top-0 right-0 w-16 h-[2px]" style={{ background: "#e07820" }} />
              <div className="absolute top-0 right-0 w-[2px] h-16" style={{ background: "#e07820" }} />
            </div>
