...
export default function CapachoEscombrosAutovolteo() {
  ...
  return (
    <>
      ...
      <section className="relative w-full overflow-hidden" style={{ aspectRatio: "21/9", minHeight: "420px" }}>
        ...
        {/* Contenido estático — barra inferior izquierda */}
      ...
      <section style={{ background: "#f5f7fa" }} className="py-20">
        <div className="max-w-[1400px] mx-auto px-6 md:px-16">
          <p className="text-[#e07820] text-xs font-bold tracking-widest uppercase mb-3">
            Componentes
          </p>
          <h2 className="text-3xl font-bold mb-12" style={{ color: "#0d1528" }}>
            Diagrama Técnico
          </h2>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Imagen con numeración */}
              ...
              {[
                ...
                >
                  ...
                  <div className="relative flex items-center justify-center w-8 h-8 cursor-pointer">
                    ...
                    {/* SVG: círculo rojo con cruz transparente recortada */}
      ...
      <section style={{ background: "#ffffff" }} className="py-20">
        <div className="max-w-[1400px] mx-auto px-6 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <h2 className="text-3xl font-bold mb-8" style={{ color: "#0d1528" }}>
              Ficha Técnica
            </h2>
              ...
              <tbody>
                {[
                  ...
                  <tr key={label} style={{ background: i % 2 === 0 ? "#f5f7fa" : "#ffffff" }}>
                    <td
                      className="px-4 py-3 font-semibold text-xs uppercase tracking-wide w-52"
                      style={{ color: "#0d1528", borderLeft: "3px solid #e07820" }}
                    >
                      {label}
                    </td>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  ...
                  style={{ borderColor: "#e07820", background: "#f5f7fa" }}
                >
      ...
      <section style={{ background: "#0d1528" }} className="py-20">
        <div className="max-w-[1400px] mx-auto px-6 md:px-16">
          <p className="text-[#e07820] text-xs font-bold tracking-widest uppercase mb-3">Línea Construcción</p>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-16 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-white/60">
              Envíanos tu consulta — te respondemos directamente, sin intermediarios.
            </p>
          </div>
          <a
            href="/contacto"
