...
import { PRODUCTOS_CONSTRUCCION, type ProductoConstruccion } from "@/data/productos-construccion";
...
export default function ProductosCarruselConstruccion({ excludeId }: Props) {
  const productos = PRODUCTOS_CONSTRUCCION.filter((p) => p.id !== excludeId);
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-16">
        ...
        <div className="relative flex items-center gap-6">
          ...
          <div className="overflow-hidden flex-1">
            ...
            >
              {productos.map((prod: ProductoConstruccion) => (
                <a
                  key={prod.id}
                  href={prod.href}
